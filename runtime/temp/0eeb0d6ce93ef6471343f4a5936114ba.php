...
<div data-am-widget="gotop" class="am-gotop am-gotop-fixed">
    <a href="#top" title="">
        <img class="am-gotop-icon-custom" src="/static/index/goTop.png" />
    </a>
</div>
...
<div class="pet_mian" id="top">
  ...
  <ul class="am-slides">
      <li>
            <img src="/static/index/img/fl01.png">
      ...
      <li>
            <img src="/static/index/img/fl02.png">
            <div class="pet_slider_font">
      ...
      <li>
            <img src="/static/index/img/fl03.png">
            <div class="pet_slider_font">
...
<div class="pet_circle_nav">
    <ul class="pet_circle_nav_list">
        ...
        <li><a href="<?php echo url('/personal'); ?>" class="iconfont pet_nav_mengzhuanti ">&#xe622;</a><span>个人中心</span></li>
        <li><a href="<?php echo url('/releaseNews'); ?>" class="iconfont pet_nav_meirong ">&#xe629;</a><span>发布</span></li>
...
<div class="pet_content_main">
      ...
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a1.png" alt=""></div>
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="/static/index/img/q1.jpg" class="pet_list_one_img" alt=""/>
            </a>
          </div>
      </li>
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a6.png" alt=""></div>
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb pet_video_info">
            ...
            <a href="###" class="">
              <img src="/static/index/img/q4.jpg" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
      <li class="am-g am-list-item-desced am-list-item-thumbed am-list-item-thumb-right pet_list_one_block">
        <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a2.png" alt=""></div>
        ...
        <div class=" am-u-sm-8 am-list-main pet_list_one_nr">
          ...
          <div class="am-u-sm-4 am-list-thumb">
            <a href="###" class="">
              <img src="/static/index/img/q5.jpg" class="pet_list_one_img" alt="我很囧，你保重....晒晒旅行中的那些囧！"/>
            </a>
          </div>
      </li>
            ...
            <li class="am-g am-list-item-desced pet_list_one_block">
              <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a3.png" alt=""></div>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list" >
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/qq1.jpg"  alt="某天 也许会相遇 相遇在这个好地方"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/qq2.jpg"  alt="不要太担心 只因为我相信"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/qq3.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
  </ul>
  ...
  am-avg-md-3 am-avg-lg-3 am-gallery-default pet_list_one_list pet_list_one_tytj" >
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w1.jpg"  alt="某天 也许会相遇 相遇在这个好地方"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w2.jpg"  alt="不要太担心 只因为我相信"/>
            </a>
        </div>
      </li>
      <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w3.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w4.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w5.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
       <li>
        <div class="am-gallery-item">
            <a href="###" class="">
              <img src="/static/index/img/w6.jpg"  alt="终会走过这条遥远的道路"/>
            </a>
        </div>
      </li>
  </ul>
            ...
            <li class="am-g am-list-item-desced pet_list_one_block">
              <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a4.png" alt=""></div>
      ...
      <li class="am-g am-list-item-desced pet_list_one_block">
              <div class="pet_list_one_info">
            <div class="pet_list_one_info_l">
                <div class="pet_list_one_info_ico"><img src="/static/index/img/a5.png" alt=""></div>
        ...
        <div class=" am-list-main">
            ...
            <div class="pet_list_zt_img"><img src="/static/index/img/c1.png" alt=""></div>
      ...
      <li class="am-g am-list-item-desced pet_list_one_block">
           <div class="pet_article_user_block">
             ...
             <img src="/static/index/img/c2.png" alt=""></div>
             <div class="pet_article_user_info">
                <div class="pet_article_user_info_ico"><img src="/static/index/img/c.png" alt=""></div>SeeYouAgain
             </div>
...
<div class="pet_article_dowload pet_dowload_more_top_off">
      ...
      <div class="pet_article_dowload_ico"><img src="/static/index/img/footdon.png" alt=""></div>
